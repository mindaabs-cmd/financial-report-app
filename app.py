...
# ==========================================
# 2. إعدادات الشريط الجانبي (بدون إدخال يدوي لأول المدة)
# ==========================================
...
def calculate_financials(target_df):
    ...
    # رأس المال والأرباح المبقاة الافتراضية
...
# ==========================================
# استخراج أرصدة بداية الفترة (أول المدة) أوتوماتيكياً من أرصدة السنة السابقة للمقارنة
# ==========================================
